...
public:
    ...
    RGB& operator=(const Tako::Vector3& other)
    {
    ...
    RGB& operator=(Tako::Vector3&& other)
    {
        this->r = static_cast<uint8_t>(other.x * 255);
        this->g = static_cast<uint8_t>(other.y * 255);
        this->b = static_cast<uint8_t>(other.z * 255);
    ...
    RGB& operator=(const Tako::Vector4& other)
    {
        this->r = static_cast<uint8_t>(other.x * 255);
        this->g = static_cast<uint8_t>(other.y * 255);
        this->b = static_cast<uint8_t>(other.z * 255);
    ...
    RGB& operator=(Tako::Vector4&& other)
    {
        this->r = static_cast<uint8_t>(other.x * 255);
        this->g = static_cast<uint8_t>(other.y * 255);
        this->b = static_cast<uint8_t>(other.z * 255);
    ...
    Tako::Vector4 to_Vector4(uint8_t a) const { return Tako::Vector4(this->r / 255.0f, this->g / 255.0f, this->b / 255.0f, a / 255.0f); }
    Tako::Vector4 to_Vector4(float a) const { return Tako::Vector4(this->r / 255.0f, this->g / 255.0f, this->b / 255.0f, a); }
    Tako::Vector3 to_Vector3() const { return Tako::Vector3(this->r / 255.0f, this->g / 255.0f, this->b / 255.0f); }
};
...
public:
    ...
    constexpr RGBA& operator=(const Tako::Vector4& other)
    {
        this->r = static_cast<uint8_t>(other.x * 255);
        this->g = static_cast<uint8_t>(other.y * 255);
        this->b = static_cast<uint8_t>(other.z * 255);
    ...
    constexpr RGBA& operator=(Tako::Vector4&& other)
    {
        this->r = static_cast<uint8_t>(other.x * 255);
        this->g = static_cast<uint8_t>(other.y * 255);
        this->b = static_cast<uint8_t>(other.z * 255);
    ...
    Tako::Vector4 to_Vector4() const { return Tako::Vector4(this->r / 255.0f, this->g / 255.0f, this->b / 255.0f, this->a / 255.0f); }
    Tako::Vector3 to_Vector3() const { return Tako::Vector3(this->r / 255.0f, this->g / 255.0f, this->b / 255.0f); }
